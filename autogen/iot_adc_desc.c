...
/* instance inst_adc config */
#include "iot_adc_cfg_inst_adc.h"
...
IotAdcDescriptor_t iot_adc_desc[] = {
  ...
  {
    /* instance number */
    .lInstNum            = IOT_ADC_CFG_INST_ADC_INST_NUM,

    /* default acq time and resolution */
    .ulDefaultAcqTime    = IOT_ADC_CFG_INST_ADC_DEFAULT_ACQ_TIME,
    .ucDefaultResolution = IOT_ADC_CFG_INST_ADC_DEFAULT_RESOLUTION,

    /* selected peripheral */
    .pxPeripheral        = IOT_ADC_CFG_INST_ADC_PERIPHERAL,
    .ucPeripheralNo      = IOT_ADC_CFG_INST_ADC_PERIPHERAL_NO,

    /* clocks and IRQ lines (ADC0) */
#if (_SILICON_LABS_32B_SERIES < 2)
#if (IOT_ADC_CFG_INST_ADC_PERIPHERAL_NO == 0)
...
#if (_SILICON_LABS_32B_SERIES < 2)
#if (IOT_ADC_CFG_INST_ADC_PERIPHERAL_NO == 1)
